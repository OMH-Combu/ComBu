...
;分岐１
[link storage=34adeliae.bunki-false.ks target=*select1]【１】「スイスで誕生した赤いお口がかわいい[r]　　　　あの大人気アニメキャラクターだ！」[endlink][r]
[link storage=33adeliae.bunki-true.ks target=*select1]【２】「お出かけやお買い物に便利な交通系ICカードだ！」[endlink][r]
[s][cm]


*common2
;アデリーtokuige
[chara_mod name="adeliae" face="tokuige"]
「俺、この白いアイリング気に入ってんだ。[l][r]
ほかのヤツにはないんだぜ」[l][cm]
